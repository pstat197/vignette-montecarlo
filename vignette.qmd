...
```{r}
knitr::include_graphics("img/simple_graph.png")
```
...
```{r}
knitr::include_graphics("img/gibbs_sample.png")
```
...
```{r}
knitr::include_graphics("img/gibbs_result.png")
```
---
...
```{r}
knitr::include_graphics("img/ising_model.png")
```
