...
![Monte Carlo workflow diagram](img/fig-MC-Workflow.jpg)
...
![Monte Carlo scatterplot for $\pi$ estimation](img/fig-pi-scatter.png)
...
![Convergence plot for $\pi$ estimation](img/fig-pi-convergence.png)
...
![Simple directed graph example](img/fig-simple-graph.png)
...
![Ising model example](img/fig-ising-model.png)
